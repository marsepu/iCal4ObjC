...
#define CG_ICALENDAR_CONTENTLINE_COMPONENT_VCALENDAR @"VCALENDAR"
#define CG_ICALENDAR_CONTENTLINE_COMPONENT_VEVENT @"VEVENT"
#define CG_ICALENDAR_CONTENTLINE_COMPONENT_VJOURNAL @"VJOURNAL"
#define CG_ICALENDAR_CONTENTLINE_COMPONENT_VFREEBUSY @"VFREEBUSY"
#define CG_ICALENDAR_CONTENTLINE_COMPONENT_VTIMEZONE @"VTIMEZONE"
